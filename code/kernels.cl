...
__kernel void init2(double dx, double dy, __global double *u,  __global double *v, __global double *psi) {
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void init_pc( __global double *u,  __global double *v,  __global double *p, __global double *uold,  __global double *vold,  __global double *pold) {
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l100(double fsdx, double fsdy, __global double *u,  __global double *v,  __global double *p, __global double *cu, __global double *cv,  __global double *z,  __global double *h) {
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l100_pc( __global double *cu,  __global double *cv, __global double *z,  __global double *h) {
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l200(double tdts8, double tdtsdx, double tdtsdy, __global double *uold,  __global double *vold,  __global double *pold, __global double *unew,  __global double *vnew,  __global double *pnew, __global double *cu,  __global double *cv,  __global double *z,  __global double *h){
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l200_pc( __global double *unew,  __global double *vnew, __global double *pnew){
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l300(double alpha,  __global double *u,  __global double *v,  __global double *p, __global double *uold,  __global double *vold,  __global double *pold, __global double *unew,  __global double *vnew,  __global double *pnew) {
    int x = get_global_id(0);
    int y = get_global_id(1);
...
__kernel void l300_pc(__global double *u,  __global double *v,  __global double *p, __global double *uold,  __global double *vold,  __global double *pold, __global double *unew,  __global double *vnew,  __global double *pnew){
    int x = get_global_id(0);
    int y = get_global_id(1);
